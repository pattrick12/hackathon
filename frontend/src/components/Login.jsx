...
const Login = ({ login, setLogin }) => {
  ...
  return (
    <div className={login ? 'visible' : 'hidden'}>
      <svg className='crossButton' onClick={handleCross} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <form action="" className="form_main">
        ...
        <button className="rounded-2xl" id="button">Submit</button>
